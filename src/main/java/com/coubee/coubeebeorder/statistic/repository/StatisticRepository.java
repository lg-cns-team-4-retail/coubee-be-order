...
public interface StatisticRepository {
     ...
     */
    DailyStatisticDto getDailyStatistic(LocalDate date);
     ...
     */
    WeeklyStatisticDto getWeeklyStatistic(LocalDate weekStartDate);
     ...
     */
    MonthlyStatisticDto getMonthlyStatistic(int year, int month);
}
